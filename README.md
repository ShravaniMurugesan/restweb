...
<head>
    ...
    <title>Green Apple Restaurant</title>
    <style>
        body {
            margin: 0;
            font-family: 'Merienda', cursive;
            background: url('rest bg.jpg') no-repeat center center fixed;
...
<body>
    ...
    <main>
        <p>Welcome to Green Apple Restaurant! Indulge in a delightful dining experience, where taste meets perfection. Explore our menu and immerse yourself in a world of exquisite flavors.</p>
    </main>
    <footer>
        <p>&copy; 2024 Green Apple Restaurant | Designed by: <b>SHRAVANI M</b></p>
        <p>
...
<div class="menu-section">
    ...
    <div class="menu-grid">
        ...
        <div class="menu-item">
            <img src="Mutton Fry.jpg" alt="Mutton 95">
            <h3>Mutton 95</h3>
        ...
        <div class="menu-item">
            <img src="crispy prawn fry.jpg" alt="Crispy Prawn Fry">
...
<div class="menu-section">
    ...
    <div class="menu-grid">
        ...
        <div class="menu-item">
            <img src="full Tandoori Chicken.jpg.jpg" alt="Tandoori Full">
            <h3>Tandoori Full</h3>
            <p>Full portion of smoky tandoori chicken.</p>
            <div class="price">₹450</div>
        </div>
        <div class="menu-item">
            <img src="chicken reshmi.webp" alt="Chicken Reshmi Kebab">
            <h3>Chicken Reshmi Kebab</h3>
            <p>Soft and juicy chicken kebabs with creamy marinade.</p>
            <div class="price">₹250</div>
        </div>
        <div class="menu-item">
            <img src="garlic kebab.jpg" alt="Chicken Garlic Kebab">
...
<div class="menu-section">
    ...
    <div class="menu-grid">
        <div class="menu-item">
            <img src="Chapati.webp" alt="Chapatti">
            <h3>Chapatti</h3>
            <p>Soft whole wheat flatbread.</p>
            <div class="price">₹40</div>
        </div>
        <div class="menu-item">
            <img src="garlic-naan-3.jpg" alt="Naan">
            <h3>Naan</h3>
            <p>Soft, pillowy leavened bread.</p>
            <div class="price">₹60</div>
        </div>
        <div class="menu-item">
            <img src="garlic-naan-3.jpg" alt="Garlic Naan">
            <h3>Garlic Naan</h3>
            <p>Soft naan topped with garlic and butter.</p>
            <div class="price">₹80</div>
        </div>
        <div class="menu-item">
            <img src="paratta.jpg" alt="Parotta">
            <h3>Parotta</h3>
            <p>Flaky and soft South Indian flatbread.</p>
            <div class="price">₹60</div>
        </div>
        <div class="menu-item">
            <img src="kizhiparatta.jpg" alt="Kizhi Parotta">
            <h3>Kizhi Parotta</h3>
            <p>Layered parotta wrapped in banana leaf.</p>
            <div class="price">₹100</div>
        </div>
        <div class="menu-item">
            <img src="skothu.jpg" alt="Kothu Parotta">
            <h3>Kothu Parotta</h3>
...
<div class="menu-section">
    ...
    <div class="menu-grid">
        ...
        <div class="menu-item">
            <img src="rasagula.jpg" alt="Rasa Gulla">
            <h3>Rasa Gulla</h3>
            <p>Soft cheese balls soaked in sugar syrup.</p>
            <div class="price">₹120</div>
        </div>
        <div class="menu-item">
            <img src="badam-kheer.jpg" alt="Badham Keer">
            <h3>Badham Keer</h3>
            <p>Sweet almond porridge with milk and sugar.</p>
            <div class="price">₹150</div>
        </div>
        <div class="menu-item">
            <img src="rasmalai.jpg" alt="Rasamalai">
            <h3>Rasamalai</h3>
            <p>Soft cheese dumplings soaked in sweet milk.</p>
            <div class="price">₹180</div>
        </div>
        <div class="menu-item">
            <img src="laddu.jpg" alt="Mothi Laddu">
            <h3>Mothi Laddu</h3>
...
<body>
    ...
    <div class="chefs-container">
        <div class="chef-card">
            <img src="Chef Damu.jpg" alt="Chef Dhamu">
        ...
        <div class="chef-card">
            <img src="Venkatesh Bhat.jpg" alt="Chef Venkat">
            <div class="chef-details">
                <h1>Mr.BHAT</h1>
        ...
        <div class="chef-card">
            <img src="deena.png" alt="Chef Dheena">
            <div class="chef-details">
                <h1>Mr.DEENA</h1>
        ...
        <div class="chef-card">
            <img src="lady 1.png" alt="Chef Sunny">
            <div class="chef-details">
                <h1>Miss Sunny</h1>
        ...
        <div class="chef-card">
            <img src="lady 2.png" alt="Chef Ishuuu">
            <div class="chef-details">
                <h1>Miss Ishuuu</h1>
        ...
        <div class="chef-card">
            <img src="lady 3.png" alt="Chef Bujjimaa">
            <div class="chef-details">
                <h1>Ms. Bujjimaa</h1>
...
<html>
    <head>
        ...
        <style>
            ...
            body{
                background-image: url("contact bgg.jpg");
    ...
    <body>
        ...
        <h5 id="n3">Phone:</h5>
        <h5 id="n4">
            <a href="tel:+919342561325">+91 9342561325</a>
        </h5>
        <h5 id="n5">Email:</h5>
        <h5 id="n6">
            <a href="mailto:greenrestaurant@gmail.com"><b>greenrestaurant@gmail.com</b></a>
        </h5>
        <h5 id="n7">Location:</h5>
        <h5 id="n8">
            <a href="https://www.google.com/maps?q=1,+Green+restaurant+OMR+street+Perungudi"><b>1, Green Apple restaurant OMR street Perungudi</b></a>
        </h5>
    </body>
</html>
```
...
## OUTPUT:
![Screenshot 2025-05-09 142314](https://github.com/user-attachments/assets/3fa3f32f-5910-4da1-9cba-059ad633f1ea)
![Screenshot 2025-05-09 142339](https://github.com/user-attachments/assets/5c0a700b-2a16-4cc9-a272-49145bd161a0)
![Screenshot 2025-05-09 144319](https://github.com/user-attachments/assets/c8c1d531-9345-44c3-95f0-f21f4d8d5938)
![Screenshot 2025-05-09 144339](https://github.com/user-attachments/assets/b5317fc3-eeff-4582-9f3d-379ebc895a3e)
